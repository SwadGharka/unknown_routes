            ...
            <div class="filter-box" id="filterBox">
                ...
                <div class="filter-grid">
                    ...
                    <div style="display: flex;">
                        <button class="apply-btn" style="background: linear-gradient(45deg, rgba(13,110,253,0.45), rgba(111,66,193,0.45));">Apply Filters</button>
                        <button class="apply-btn reset" style="background: linear-gradient(45deg, rgb(59 13 253 / 57%), rgb(255 0 0 / 77%));">Reset</button>
                    </div>
                </div>
