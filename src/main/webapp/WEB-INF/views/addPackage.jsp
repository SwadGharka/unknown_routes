	...
	<%@ taglib prefix='c' uri='http://java.sun.com/jsp/jstl/core' %>
		...
		<body>
			<%@ include file="header.jsp" %>
				<!-- Step 1 -->
				<div class="">
					<input type="hidden" id="newPackageId" value="">
					<input type="hidden" id="visitedPackageId" value="${packageId}">
					<form class="form-container active" id="step1">
						...
						<div class="form-grid">
							...
							<div class="form-right">
								...
								<textarea id="inclusionsForCard" name="inclusionsForCard"
									placeholder="Inclusion 1, Inclusion 2, Inclusion 3, Inclusion 4"></textarea>
								...
								<input type="text" id="offerBadge" name="offerBadge" placeholder="Enter Offer Badge"
									required>
								<div style="display: flex;">
									...
									<div class="btn-wrapper" style="width: 48%; height: 60%;margin-left: 52%;"> 
										<button class="button next-btn" type="button" id="toActivities"
											onclick="saveStep1('step1')">Next ➜</button>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="activities-container" id="step2">
					...
					<div class="btn-group">
						...
						<button class="button next-btn" type="button" id="toExtras" onclick="saveActivities()">Next
							➜</button>
					</div>
				</div>
				...
				<div class="extra-fields" id="step3">
					...
					<div class="btn-group">
						...
						<button class="button next-btn" type="submit" id="addPackage"
							onclick="saveAdditionalDetails()">Add Package ✅</button>
					</div>
				</div>
				<script>
					$(document).ready(function () {
						...
						if ($("#visitedPackageId").val() != null && $("#visitedPackageId").val() != undefined && $("#visitedPackageId").val() != '') {
							getPackageDetails();
						}
					});
